...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "errorMsgUserNotRegistered":
            MessageLookupByLibrary.simpleMessage("用户未注册"),
        ...
        "labelAskFirstReview":
            MessageLookupByLibrary.simpleMessage("快来做第一个点评吧"),
        ...
        "labelClickToAddImage":
            MessageLookupByLibrary.simpleMessage("点击添加商品图片"),
        ...
        "labelNewCommentPageComment":
            MessageLookupByLibrary.simpleMessage("您有什么要说?"),
        "labelNewCommentPageCommentErrorMessage":
            MessageLookupByLibrary.simpleMessage("点评不可为空"),
        ...
        "labelRegisterYourAccount":
            MessageLookupByLibrary.simpleMessage("开始您的jomn9之旅"),
        "labelRememberMe": MessageLookupByLibrary.simpleMessage("记住我"),
        "labelResetLoginPassword":
            MessageLookupByLibrary.simpleMessage("重置登录密码"),
        ...
        "locationSelectTownMessage":
            MessageLookupByLibrary.simpleMessage("选择区"),
        "locationServiceLocating":
            MessageLookupByLibrary.simpleMessage("定位中..."),
        "locationServiceNoGps": MessageLookupByLibrary.simpleMessage("没有GPS"),
        "locationServicePromptEnableGps":
            MessageLookupByLibrary.simpleMessage("请在设置中提供位置服务权限"),
        "locationServicePromptPermission":
            MessageLookupByLibrary.simpleMessage("手机定位服务未开启"),
        "locationServiceRetryOperation":
            MessageLookupByLibrary.simpleMessage("重试"),
        "msgMustHaveAtLeastOneAccount":
            MessageLookupByLibrary.simpleMessage("您始终需要至少连接一个帐户"),
        "msgPleaseFillRequiredField":
            MessageLookupByLibrary.simpleMessage("栏位不能为空"),
        ...
        "overviewSection1Para2": MessageLookupByLibrary.simpleMessage(
            "芙蓉市首府东北部的迪克森港以其殖民时期的建筑，湖花园公园和Minangkabau人的木宫殿而闻名，Minangkabau人是印尼裔。他们的影响力也可见于东部的Seri Menanti，以前的宫殿现在是Sri Menanti皇家博物馆，附近的瓜拉皮拉镇（Kuala Pilah）是San Sheng Gong Chinese Temple和五颜六色的印度教寺庙Kuil Sri Kanthasamy的所在地，向西是Ulu Bendul Recreational公园包括丛林，瀑布和Gunung Angsi山。"),
        "overviewSection2Para1": MessageLookupByLibrary.simpleMessage(
            "该名称被认为是由Minangkabau居住的Minangkabau语言（现在称为luak）中的9个（森比亚人）村庄或nagari所居住的，Minangkabau是最初来自西苏门答腊（现今印度尼西亚）的人。Minangkabau如今，在传统建筑和马来语方言中，功能仍然很明显。"),
        "overviewSection2Title":
            MessageLookupByLibrary.simpleMessage("森州名称的由来"),
        "overviewSection3Para1": MessageLookupByLibrary.simpleMessage(
            "与其他皇家马来国家的世袭君主不同，森美兰的统治者被称为扬·迪·普尔图安·贝萨尔，而不是苏丹。统治者的选举也很独特。他是由昂当斯理事会选出的他领导着双溪Ujong，Jelebu，Johol和Rembau四个最大领土，使其成为民主制君主制之一。森美兰的首都是芙蓉，皇家首都是瓜拉皮拉区的Seri Menanti，其他重要城镇是港口迪克森，巴豪和汝来。"),
        ...
        "overviewSection4Para1": MessageLookupByLibrary.simpleMessage(
            "芙蓉市是森美兰州的首府，如今该州的经济主要以农业部门为基础，棕榈，橡胶以及果蔬农场占该州土地面积的一半。它们也是该州的领导者之一。最近，随着住宅增长的需求，芙蓉市及其周边地区兴建了可负担房屋的住宅，发展迅猛，距吉隆坡仅40分钟路程，这对那些无法负担天文数字的中产马来人来说是一个加分首都的生活费用。"),
        "overviewSection4Title":
            MessageLookupByLibrary.simpleMessage("首都（芙蓉市）"),
        ...
        "placeDetailMerchantRegistrationNameLabel":
            MessageLookupByLibrary.simpleMessage("注册名字"),
        "placeDetailMerchantSSMLabel":
            MessageLookupByLibrary.simpleMessage("SSM号"),
        "placeDetailOpeningHoursLabel":
            MessageLookupByLibrary.simpleMessage("营业时间"),
        "placeDetailOperatingCloseLabel":
            MessageLookupByLibrary.simpleMessage("休息"),
        "placeDetailOperatingOpenLabel":
            MessageLookupByLibrary.simpleMessage("营业"),
        "placeDetailOperatingSoonLabel":
            MessageLookupByLibrary.simpleMessage("即将休息"),
        ...
        "tabViewLabelProfessional":
            MessageLookupByLibrary.simpleMessage("专业服务"),
        "tabViewLabelShop": MessageLookupByLibrary.simpleMessage("美食商店"),
        "toastMessageTapToExit":
            MessageLookupByLibrary.simpleMessage("再次点击退出应用")
      };
}
