...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(len) => "密码必须至少为${len}个字符";

  static m4(item) => "输入您的${item}";

  static m5(item) => "正火速上传您的${item}";

  static m6(uname) => "${uname},很高兴认识你";

  static m7(commentCount) => "点评 (${commentCount})";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "clickItemSettingAboutTitle" : MessageLookupByLibrary.simpleMessage("关于我们"),
    ...
    "labelGoogle" : MessageLookupByLibrary.simpleMessage("谷歌"),
