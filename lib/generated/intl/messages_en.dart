...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m5(item) => "Adding your ${item}";

  static m6(uname) => "Nice to meet you ${uname}";

  static m7(commentCount) => "${Intl.plural(commentCount, one: 'Comment (1)', other: 'Comments (${commentCount})')}";
