...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(uname) => "Nice to meet you ${uname}";

  static m4(commentCount) => "${Intl.plural(commentCount, one: 'Comment (1)', other: 'Comments (${commentCount})')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "errorMsgAccountExist" : MessageLookupByLibrary.simpleMessage("Email is used"),
