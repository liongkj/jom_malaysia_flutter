...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m13(email) => "An Email is sent to ${email}. Please follow the instructions.";

  static m14(text) => "Awww... No result found for \'${text}\'";

  static m15(uname) => "Nice to meet you ${uname}";

  static m16(commentCount) => "${Intl.plural(commentCount, one: 'Comment (1)', other: 'Comments (${commentCount})')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "clickItemSettingAboutTitle" : MessageLookupByLibrary.simpleMessage("About JomN9"),
    ...
    "labelLeaveAReview" : MessageLookupByLibrary.simpleMessage("Leave a review"),
    "labelLinkedWith" : m7,
